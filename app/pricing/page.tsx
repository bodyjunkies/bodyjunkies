              ...
              <article className="flex h-full flex-col rounded-2xl border border-[var(--bj-red)]/60 bg-[var(--bj-red)]/15 p-5 transition-colors hover:border-[var(--bj-red)]/80 hover:bg-[var(--bj-red)]/20">
                <div className="flex-1">
                  ...
                  <p className="mt-3 text-sm text-white/85">
                    Perfect for beginners. <span className="font-bold text-white">Includes the Boxing Induction and a group session, plus your own gloves and wraps to keep</span>, so you can build a strong foundation from day one.
                  </p>
                </div>
